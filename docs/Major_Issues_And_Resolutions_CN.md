...
| 2026-04-18 | P1-3 实测 **`nav_p1_reg200_rule_entity_match_k4_20260418_030137Z`**：**`question_entity_match_topk` 与 overlap 金叶过程量同值**；P1 读侧三刀可收口，见 `Navigation_Experiment_Record_CN.md` §6.6。 |
