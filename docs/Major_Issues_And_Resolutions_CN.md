...
| 2026-04-18 | **P0-A′** 导航 **`n=500`**、`probe_budget=2`：`reject_leaf_branch_cap` 叶次 **≈44/41**（对 e2e 基线 **≈85/76**）；**`never_visit_any_gold`** 仍 **≈0.58/0.55**；表与判读见 `Navigation_Experiment_Record_CN.md` §6.6。 |
